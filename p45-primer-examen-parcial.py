...
while(True):
    ...
    while suma <= 5000000000000 : 
        ...
        if tusuario == 1 and tpaquete == 2:
            tusuario = "Alumno"
            tpaquete = "Solo conferencia"
            subtotal = (alumno + eventosocial)*cant
            if subtotal > 5000 :
               descuento = subtotal * 0.20
               total = subtotal-descuento
        ...
        if tusuario == 1 and tpaquete == 3:
            ...
            subtotal = (alumno + kitacceso)*cant
            if subtotal > 5000:
               descuento = subtotal*0.20
               total = subtotal-descuento
        ...
        print(f"El pedido fue: {cant}")
        print(f"El tipo de usuario es : {tusuario}")
        print(f"El paquete es: {tpaquete}")
